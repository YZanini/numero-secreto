...
function gerarNumeroAleatorio() {
    ...
    let quantidadeElementosNaLista = listaNumerosSelecionados.length;

    if (quantidadeElementosNaLista == numeroMaximo) {
        listaNumerosSelecionados = [];
    }
    if (listaNumerosSelecionados.includes(numeroEscolhido)) {
        return gerarNumeroAleatorio();
    } else {
        listaNumerosSelecionados.push(numeroEscolhido);
        console.log(listaNumerosSelecionados);
